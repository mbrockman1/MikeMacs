...
; Users/michael/.emacs.d/el-get/freex
; Users/michael/org/freex/
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;; Add freex scripts (lisp and python files) to the load path ; xxx
(add-to-list 'load-path "/Users/michael/.emacs.d/el-get/freex")
...
;; Load pymacs
;;; NOTE Load pymacs using the following:
;;; pip install -e "git+https://github.com/pinard/pymacs.git#egg=pymacs"
;;; cd Users/michael/src/pymacs
;;; make
;;; Now test it:
;;; You can test the installation by changing to a directory that does
;;; not contain pymacs and running:
...
(eval-after-load "pymacs"
  '(add-to-list 'pymacs-load-path "/Users/michael/.emacs.d/el-get/freex"))
;; xxx

;; Specify where the freex .db file and its .freex (or .muse) friends
;; will live.  (Make sure this directory exists.)
(setq freex-mode-dir "/Users/michael/org/freex/") ; xxx
...
;;; This had to be added to make implicit links work. The author
;;; mistakenly removed this, but it is still required.
...
(load "/Users/michael/.emacs.d/el-get/freex/freex-mode.el") ; xxx
